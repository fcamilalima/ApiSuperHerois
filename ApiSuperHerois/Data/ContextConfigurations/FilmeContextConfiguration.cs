...
class FilmeContextConfiguration : IEntityTypeConfiguration<Filme>
{
    private Guid[] _ids;
        ...
        builder
            .HasData(
                ...
                new Filme
                {
                    ...
                    Descricao = "Guerra nas estrelas: Episode V – O império contra ataca The Empire Strikes Back (também conhecido como Star Wars: Episódio V – The Empire Strikes Back) é um filme épico americano de ópera espacial de 1980 dirigido por Irvin Kershner e escrito por Leigh Brackett e Lawrence Kasdan, baseado em uma história de George Lucas..",
